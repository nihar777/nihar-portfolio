...
`const home = {
  label: "Home",
  title: "Nihar Devmurari's Portfolio",
  description: "Portfolio website showcasing my work as a Mobile App Developer",
  headline: <>Mobile app developer and builder</>,
  subline: (
    <>
      I'm Nihar, a mobile app developer specializing in{" "}
      <InlineCode>React Native</InlineCode>, where I create seamless cross-platform
      apps.<br /> Beyond client work, I explore and build my own projects.
    </>
  ),
};`,
    language: "tsx",
